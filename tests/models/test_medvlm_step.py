...
#use custom tokenizer class as wrapper
...
model = MedVLM(tokenizer_y=tokenizer, data_type="CT", use_llm=False, 
               text_encoder="microsoft/BiomedVLP-CXR-BERT-specialized", only_cl=True,
               use_multiencoder=True 
               #, backbone_type="resnet", model_size=34
               )
